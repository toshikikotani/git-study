    ...
    <div className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col">
      ...
      <div className="fixed inset-x-0 bottom-0 px-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
        <div className="mx-auto flex w-full max-w-md items-center gap-2">
          ...
          {/* タブに埋めず単独のボタンにする=「主な取り込み口はここ」を
              一目でわかるようにする(本人発案)。 */}
          <Link
            href="/transactions/receipt"
            aria-label="レシートを撮る"
            className="flex size-14 shrink-0 flex-col items-center justify-center gap-0.5 rounded-full ring-1 backdrop-blur-xl"
            style={{
          ...
          >
            ...
            <span className="text-[10px] leading-none font-semibold">撮る</span>
          </Link>
        </div>
      </div>
    </div>
